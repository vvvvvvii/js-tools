...
function submitNewItem(e) {
  e.preventDefault();
  const startHourValue = Number(startHour.value);
  const startMinValue = Number(startMin.value);
  const endHourValue = Number(endHour.value);
  const endMinValue = Number(endMin.value);
